...
FilenameModel: "model_cnn.h5" [Filename of the initial Keras model]
FilenameTrainedModel: "trained_model_cnn.h5" [Filename of the trained output Keras model]
