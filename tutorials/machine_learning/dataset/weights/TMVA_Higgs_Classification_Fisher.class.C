...
{
   fFisher0 = 0.124916189191;
   fFisherCoefficients.push_back( -0.0509394269288 );
   fFisherCoefficients.push_back( 0.187223576388 );
   fFisherCoefficients.push_back( 0.036575735648 );
   fFisherCoefficients.push_back( 0.0652501812159 );
   fFisherCoefficients.push_back( -0.207319932897 );
   fFisherCoefficients.push_back( 0.531510435798 );
   fFisherCoefficients.push_back( -0.743486319931 );
