...
Method         : PyTorch::PyTorch
TMVA Release   : 4.2.1         [262657]
ROOT Release   : 6.35/01       [402177]
Creator        : prasanna
Date           : Sat Mar 15 22:11:38 2025
...
FilenameModel: "PyTorchModelCNN.pt" [Filename of the initial PyTorch model]
FilenameTrainedModel: "PyTorchTrainedModelCNN.pt" [Filename of the trained output PyTorch model]
BatchSize: "100" [Training batch size]
NumEpochs: "10" [Number of training epochs]
UserCode: "/home/prasanna/RootDevelopment/build/tutorials/machine_learning/PyTorch_Generate_CNN_Model.py" [Necessary python code provided by the user to be executed before loading and training the PyTorch Model]
# Default:
...
class ReadPyTorch : public IClassifierReader {

 public:

   // constructor
   ReadPyTorch( std::vector<std::string>& theInputVars )
      : IClassifierReader(),
        fClassName( "ReadPyTorch" ),
        fNvars( 256 )
   {
...
inline double ReadPyTorch::GetMvaValue( const std::vector<double>& inputValues ) const
{
