...
Method         : DL::TMVA_CNN_CPU
TMVA Release   : 4.2.1         [262657]
ROOT Release   : 6.35/01       [402177]
Creator        : prasanna
Date           : Sat Mar 15 22:11:25 2025
...
class ReadTMVA_CNN_CPU : public IClassifierReader {

 public:

   // constructor
   ReadTMVA_CNN_CPU( std::vector<std::string>& theInputVars )
      : IClassifierReader(),
        fClassName( "ReadTMVA_CNN_CPU" ),
        fNvars( 256 )
   {
...
inline double ReadTMVA_CNN_CPU::GetMvaValue( const std::vector<double>& inputValues ) const
{
